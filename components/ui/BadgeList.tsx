    ...
    <Table variant='simple'>
      <Thead position='sticky' top={-1} zIndex='docked'>
        <Tr bg='gray.100'>
          ...
          <Th className='pc-only' whiteSpace='nowrap' borderWidth='1px' bg='gray.200' color='#262626' fontSize='md' textAlign='center'>取得可能</Th>
          <Th className='pc-only' whiteSpace='nowrap' borderWidth='1px' bg='gray.200' color='#262626' fontSize='md' textAlign='center'>取得予定</Th>
          <Th className='pc-only' whiteSpace='nowrap' borderWidth='1px' bg='gray.200' color='#262626' fontSize='md' textAlign='center'>獲得済み</Th>
          <Th className='pc-only' whiteSpace='nowrap' borderWidth='1px' bg='gray.200' color='#262626' fontSize='md' textAlign='center'>能力バッジ概要</Th>
        </Tr>
      </Thead>
      <Tbody>
        {portfolioBadges.map((row) => (
          <Tr display={selectedConsumer == row.consumer_name && (!row.special || (validPassword && row.special))? 'table-row' : 'none'}>
            ...
            <Td className='pc-only' borderWidth='1px' borderColor='gray.200' bg='white'>
